const TRUC_INFO = {
  ...
  "Phá": {
    ...
    rating: "Rất Xấu (Chính là Nguyệt Phá)",
  ...
  "Khai": {
    ...
    rating: "Rất Tốt (Ngày sinh khí mạnh)",
  ...
  "Bế": {
    ...
    rating: "Xấu nhưng đặc biệt tốt cho tang lễ",
